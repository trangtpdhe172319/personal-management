...
const AppRouter = () => {
  ...
  return (
    <div className={currentMode === "Dark" ? "dark" : ""}> {/* Áp dụng class dark nếu mode là Dark */}
      <BrowserRouter> {/* Sử dụng Router để điều hướng trang */}
        <Routes> {/* Các route trong ứng dụng */}
          ...
          <Route
            ...
            element={
              <PrivateRoute>  {/* Bảo vệ các route này bằng PrivateRoute */}
                <div className="flex relative dark:bg-main-dark-bg"> {/* Giao diện chính với sidebar, navbar */}
                  <div className="fixed right-4 bottom-4" style={{ zIndex: "1000" }}>
                    <TooltipComponent content="Settings" position="Top"> {/* Tooltip cho nút Settings */}
                      <button
                        type="button"
                  ...
                  >
                    ...
                    <div>
                      {themeSettings && <ThemeSettings />}  {/* Nếu mở cài đặt theme, hiển thị ThemeSettings */}
